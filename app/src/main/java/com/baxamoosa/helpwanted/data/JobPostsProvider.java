...
public class JobPostsProvider extends ContentProvider {
    ...
    private JobPostsDbHelper mOpenHelper;
    ...
    public boolean onCreate() {
        mOpenHelper = new JobPostsDbHelper(getContext());
        return true;
    }
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (match) {
            case JOBPOSTS: {
                long _id = db.insert(JobPostContract.JobPostList.TABLE_NAME, null, values);
                if (_id > 0)
                    returnUri = JobPostContract.JobPostList.buildJobPostsUri(_id);
                else
